...
const GLOSSARY = {
  ...
  // 핸드 표기법 (77+, AKs, Q7s 등)
  '77+': { detail: '포켓 7 페어 이상 — 77, 88, 99, TT, JJ, QQ, KK, AA 전부 포함.' },
  '22+': { detail: '포켓 2 페어 이상 — 22부터 AA까지 모든 포켓 페어.' },
  '55+': { detail: '포켓 5 페어 이상 — 55부터 AA까지.' },
  '66+': { detail: '포켓 6 페어 이상 — 66부터 AA까지.' },
  '88+': { detail: '포켓 8 페어 이상 — 88부터 AA까지.' },
  '99+': { detail: '포켓 9 페어 이상 — 99부터 AA까지.' },
  'AA': { detail: '포켓 에이스 (A 2장) — 프리플롭 최강.' },
  'KK': { detail: '포켓 킹 (K 2장) — 두 번째로 강한 핸드.' },
  'QQ': { detail: '포켓 퀸 (Q 2장) — 상위 프리미엄.' },
  'AKs': { detail: 'Ace-King 수딩(같은 무늬). "빅 슬릭" 수딩. 프리미엄.' },
  'AKo': { detail: 'Ace-King 오프슈트(다른 무늬). 여전히 프리미엄.' },
  'AQs': { detail: 'Ace-Queen 수딩.' },
  'AQo': { detail: 'Ace-Queen 오프슈트.' },
  'ATs': { detail: 'Ace-Ten 수딩 (A와 10이 같은 무늬).' },
  'ATs+': { detail: 'ATs 이상 — ATs, AJs, AQs, AKs 포함.' },
  'AJo+': { detail: 'AJo 이상 — AJo, AQo, AKo 포함.' },
  'KTs+': { detail: 'KTs 이상 — KTs, KJs, KQs 포함.' },
  'QTs+': { detail: 'QTs 이상 — QTs, QJs 포함.' },
  'JTs': { detail: 'Jack-Ten 수딩 — 플러시·스트레이트 잠재력 높음.' },
  'T9s': { detail: '10-9 수딩 — 수딩 커넥터.' },
  'Q7s': { detail: 'Queen-7 수딩(Q와 7이 같은 무늬). BTN 같은 넓은 레인지에서만 사용.' },
  'J9s': { detail: 'Jack-9 수딩 — 한 칸 갭 수딩 커넥터(갭퍼). BTN에서 플레이 가능.' },
  'J8s': { detail: 'Jack-8 수딩 — 넓은 레인지에서 플레이.' },
  '98s': { detail: '9-8 수딩 커넥터.' },
  '87s': { detail: '8-7 수딩 커넥터.' },
  '76s': { detail: '7-6 수딩 커넥터.' },
  '65s': { detail: '6-5 수딩 커넥터.' },
  '54s': { detail: '5-4 수딩 커넥터.' },
  'T (카드)': { detail: '포커에서 T = 10을 의미. 예: T9s = 10-9 수딩.' },
