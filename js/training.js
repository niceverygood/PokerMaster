...
const LESSONS = [
  {
    ...
    content: `
      ...
      <h3>3. 실전 원칙</h3>
      <ol>
        <li>UTG에서 <b>77+</b>(포켓 7 페어 이상 — 77·88·99·TT·JJ·QQ·KK·AA) 같은 강한 핸드만 오픈하세요.</li>
        <li>BTN에서는 <b>Q7s</b>(Q-7 수딩 = 같은 무늬의 Q와 7), <b>J9s</b>(J-9 수딩) 같은 플레이어블 핸드도 공격적으로 오픈합니다.</li>
        <li>SB에서는 림프(콜) 대신 레이즈 또는 폴드가 원칙입니다.</li>
      </ol>
      <h3>4. 핸드 표기법 — 먼저 알고 가세요!</h3>
      <ul>
        <li><b>AA, KK, 77</b>: 포켓 페어 (같은 숫자 2장)</li>
        <li><b>AKs</b>: A와 K가 <b>같은 무늬</b>(s = suited)</li>
        <li><b>AKo</b>: A와 K가 <b>다른 무늬</b>(o = offsuit)</li>
        <li><b>77+</b>: 77 이상 모든 포켓 페어 (77~AA)</li>
        <li><b>ATs+</b>: A-10 수딩 이상 (ATs, AJs, AQs, AKs)</li>
        <li><b>T</b>: 10을 나타내는 기호 (T9s = 10-9 수딩)</li>
      </ul>
      <h3>4. 왜 중요한가</h3>
